...
public class BasicNVTest {
    static TestManager testManager;
    static Test siteTest;
    static String browser, proxySetting, serverIp, username, password;
    ...
    public static void main(String[] args) {
        try {
             ...
             String testDescription = "***   This sample demonstrates the use of the most basic NV methods.                               ***" + newLine +
                                      ...
                                      "***   (\"3G Busy\" is one of NV's built-in network profiles. A network profile specifies the         ***" + newLine +
                                      "***   network traffic behavior, including latency, packet loss, and incoming/outgoing bandwidth.   ***" + newLine +
                                      "***   Network profiles are used to emulate traffic over real-world networks.)                      ***" + newLine +
                                      "***                                                                                                ***" + newLine +
                                      ...
                                      "***                                                                                                ***" + newLine +
                                      "***   Finally, the sample stops the NV test.                                                       ***" + newLine +
                                      "***                                                                                                ***" + newLine +
                                      "***   You can view the actual steps of this sample in the BasicNVTest.java file.                   ***" + newLine;
    ...
    public static void startTest() throws Exception {
        ...
        String testName =  "BasicNVTest Sample Test";

...
public class BasicAnalyzeNVTransactions {
    ...
    public static void main(String[] args) {
        try {
             ...
             String testDescription = "***   This sample demonstrates how to run transactions as part of an NV test.                                               ***" + newLine +
                                      "***                                                                                                                         ***" + newLine +
                                      "***   In this sample, the NV test starts with the \"3G Busy\" network scenario, running three transactions (see below).       ***" + newLine +
                                      "***   After the sample stops and analyzes the NV test, it prints the analysis .zip file path to the console.                ***" + newLine +
                                      "***                                                                                                                         ***" + newLine +
                                      "***   This sample runs three NV transactions:                                                                               ***" + newLine +
                                      ...
                                      "***                                                                                                                         ***" + newLine +
                                      "***   You can view the actual steps of this sample in the BasicAnalyzeNVTransactions.java file.                             ***" + newLine;
            ...
            printPartDescription("------    Part 3 - Stop the NV test, analyze it and print the results to the console");
            stopTestAndAnalyze();
            testRunning = false;
            printPartSeparator();
            doneCallback();
    ...
    public static void startTest() throws Exception {
        ...
        String testName =  "BasicAnalyzeNVTransactions Sample Test";
